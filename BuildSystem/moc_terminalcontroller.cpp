...
**
** Created: Wed Dec 26 11:01:08 2012
...
static const char qt_meta_stringdata_TerminalController[] = {
    "TerminalController\0"
};
...
const QMetaObjectExtraData TerminalController::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TerminalController::staticMetaObject = {
    { &QProcess::staticMetaObject, qt_meta_stringdata_TerminalController,
      qt_meta_data_TerminalController, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TerminalController::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TerminalController))
